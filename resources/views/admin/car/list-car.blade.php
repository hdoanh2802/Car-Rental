    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{ route('car.create') }}" class="btn btn-success float-right m-2">ADD</a>
                    </div>
                    <div class="col-md-12">
                        <table class="table">
                            <thead>
                            ...
                            <tbody>
                                @foreach ($cars as $car)
                                    <tr>
                                        ...
                                        <td>{{ $car->purch_date }}</td>
                                        <td> <img src="{{ asset("$car->image_path") }}" width="100" height="100" />
                                        </td>
                                        <td>{{ $car->price_start }}</td>
                                        <td>{{ $car->price_hourly }}</td>
                                        <td>
