...
@section('title')
    <title>List office</title>
@endsection
@section('content')
    <div class="content-wrapper">

        @include('partials.content-header', ['name' => 'office', 'key' => 'List'])
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <a href="{{ route('office.create') }}" class="btn btn-success float-right m-2">ADD</a>
                    </div>
                    <div class="col-md-12">
                        <table class="table">
                            <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('office.edit', ['id' => $office->id]) }}"
                                                class="btn btn-default"><svg xmlns="http://www.w3.org/2000/svg" width="16"
